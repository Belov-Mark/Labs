...
Выходной [```people.csv```](./data/out/people.csv)

Результат работы функции ```csv_to_json```

Входной файл [```people.csv```](./data/samples/people.csv)

Выходной [```people.json```](./data/out/people.json)
...
Выходной [```people.xlsx```](./data/out/people.xlsx)
